...
const db = new Database("C:\\Users\\donbo\\Documents\\Coding\\WebDev\\webdev\\mapping_with_openStreet_leaflet\\hittastic\\wadsongs.db")
...
/////////// locations of artists///////////// to see the updated wardsongs 
...
app.get("/homeArtist/:artistp", (req, res) => {
...
///////////////////////////// map post adding stuff ////////////////

app.post("/artistAdd/:name/:lat/:lon/:hometown", (req, res) => {
